...
export default function ViewOrders() {
  ...
  const { getOrders, userOrders, orderList, deleteOrder, setOrderList } = useContext(MyContext);
          ...
          {userOrders.map((order) => (
            ...
            >
              <div className="flex justify-between items-center mb-3">
                ...
                {/* Would like to possibly add date later here */}
                Date
                {/* <span className="text-sm text-[#a8b2a1]">{order.orderdate}</span> */}
              </div>
              ...
              <div className="flex gap-3">
                ...
                {/* These buttons will be added only if they are admin to do later */}
                {/* <button className="bg-[#7c7f65] hover:bg-[#a8b2a1] text-white px-4 py-2 rounded-lg text-sm">
                  Confirm
                </button>
